...
describe Renshi::Parser do  
    ...
    it "should understand double quotations marks within ruby code!" do
      ...
      #     
      # doc = Nokogiri::HTML(%Q!${foo "1", foo("3", "4")}!)
      # 
      # puts doc.root
      #     
      ...
      # 
      html = interpret("data/quots.ren", binding)
      html = N(html)
      (html/"div[@id='body']").text.strip.should =~ /1, 2/      
    end
    ...
    #   foo
    # end
    # it "should understand rails helpers" do
    #   #${link_to "alter this template", edit_foo(PageTemplate.find_by_file_name("default.html.erb"))}       
    # 
    #   doc = Nokogiri::HTML(%Q!${link_to "alter this template", edit_foo("default.html.erb)}!)
    # 
    #   body = doc.root.children.first
    #   node = body.children.first
    #   eval(deliver_compiled(node), binding).should eql "1, 3, 4"
